...
CREATE TABLE orders (
 ...
 `delivery_address_2` varchar(256) COLLATE utf8_unicode_ci,
 `delivery_address_3` varchar(256) COLLATE utf8_unicode_ci,
 ...
 `added_by` varchar(30) COLLATE utf8_unicode_ci,
 `code` varchar(256) COLLATE utf8_unicode_ci,
