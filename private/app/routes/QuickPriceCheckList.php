...
$app->get('/quick-price-checklist', function (Request $request, Response $response) use ($app) : Response{

    return $this->view->render($response,'QuickPriceCheckList.twig', array(
