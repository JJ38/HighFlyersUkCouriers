...
$app->get('/poultry-fowl-prices', function (Request $request, Response $response) use ($app) : Response{

    return $this->view->render($response,'PoultryAndFowlPrices.twig', array(
