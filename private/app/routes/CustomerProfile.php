...
$app->get('/customer-profile[/updated]', function (Request $request, Response $response) use ($app) : Response{
    ...
    if($account_type == "customer"){
        ...
        return $this->view->render($response,'customer-profile.html');
    }
...
$app->post('/customer-profile', function (Request $request, Response $response) use ($app) : Response{
