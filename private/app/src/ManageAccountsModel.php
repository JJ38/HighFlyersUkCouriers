...
class ManageAccountsModel
{
    ...
    public function createFirestoreStaffDocument() : void{
        ...
        if($this->firebase_firestore != null){
            ...
            try{
                ...
                $this->firebase_firestore->addDocument('Staff', [
                    'assignedRuns' => [],
                    'staffName' => str_replace("@placeholder.com", "", $this->email),           
                ], $this->uid);
                ...
                if ($this->logger !== null) {
                    ...
                    $this->logger->error("FIREBASE_FIRESTORE_CREATE_STAFF_DOCUMENT_ERROR", array($e));
                    $this->logger->error("FIREBASE_FIRESTORE_CREATE_STAFF_DOCUMENT_PARAMETERS", array($this->email, $this->role));
