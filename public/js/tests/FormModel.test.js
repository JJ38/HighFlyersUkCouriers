...
//calculateOrderPrice(collectionPostcodeInput, deliveryPostcodeInput, quantityInput, boxesInput, animalTypeInput, birdSpecies, pricePostcodeDefinitions, birdSpeciesSet)
...
describe('Order Price Calculation', () => {
  ...
  describe('Invalid Inputs', () => {
    ...
    test('should return false for a quantity of 0', () => {
      expect(calculateOrderPrice("DE56 1TP", "S17 3AL", 0, 1, "Pigeons - Young Birds", birdSpecies, pricePostcodeDefinitions, birdSpeciesSet)).toBe(false);
    });

    test('should return false for a negative quantity', () => {
      expect(calculateOrderPrice("DE56 1TP", "S17 3AL", -1, 1, "Pigeons - Young Birds", birdSpecies, pricePostcodeDefinitions, birdSpeciesSet)).toBe(false);
    });

    test('should return false for an invalid animal type', () => {
      expect(calculateOrderPrice("DE56 1TP", "S17 3AL", 1, 1, "Invalid Animal", birdSpecies, pricePostcodeDefinitions, birdSpeciesSet)).toBe(false);
    });
    ...
    test('should return false for a non-string animal type', () => {
      expect(calculateOrderPrice("DE56 1TP", "S17 3AL", 1, 1, 12345, birdSpecies, pricePostcodeDefinitions, birdSpeciesSet)).toBe(false);
    });
  });
